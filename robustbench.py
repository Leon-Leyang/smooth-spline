...
def replace_and_test_robustness_on(model_id, threat, beta_vals, dataset, n_examples):
    batch_size = 70
    mode = 'normal'
...
def main():
    ...
    for model_id in args.model_ids:
        replace_and_test_robustness_on(model_id, threat, beta_vals, dataset, n_examples)
